...
newTrial("instructionsReminder2",
    ...
    newText("instruReminderNote3", "You must act quickly! You will only have 1 second to press the button if you see the target. Otherwise, the trial will be marked as an error.").css("padding","5px").css("font-weight","bold").css("text-align","center").center().print(),
    newButton("reminderNext", "Next").css("padding","5px").css("text-align","center").center().print().wait()
);
...
function makeEpochIntro(trialName, targetImageFile, trialsCompleted) {
    ...
    newTrial(trialName,
        ...
        newText("blockNote2", "(Remember that the image may appear as it does on the left, or mirror-flipped as on the right. You should respond to the target in both cases!)").css("padding","5px").css("text-align","center").center().print(),
        ...
        newText("blockReady", "When ready, press Enter/Spacebar or click 'Begin Block' to begin the sequence. Get ready!").css("padding","5px").css("text-align","center").center().print(),
