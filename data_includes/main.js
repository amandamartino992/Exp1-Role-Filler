...
function makeEpochIntro(trialName, targetImageFile, trialsCompleted) {
    ...
    newTrial(trialName,
        ...
        newText("blockNote", "Here is the target image. (Remember that the image may appear as it does on the left, or mirror-flipped as on the right. You should respond to the target in both cases!)").css("padding","5px").css("text-align","center").center().print(),
